            ...
            <template #default="scope">
              <div class="table-avatar">
                <img
                  :src="
                    scope.row.avatar
                      ? `${proxy.baseURL}${scope.row.avatar}`
                      : proxy.defaultAvatar
                  "
                  alt="" />
              </div>
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="头像"
              ><commonUserAvatar v-model="form.avatar" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
        ...
        <template #tip>
          <div class="el-upload__tip text-center">
            <div class="el-upload__tip">
              <el-checkbox
                v-model="upload.updateSupport" />是否更新已经存在的用户数据
            </div>
...
import commonUserAvatar from './profile/commonUserAvatar.vue'
  ...
  proxy.$refs['userRef'].validate(valid => {
    if (valid) {
      ...
      if (form.value.userId != undefined) {
        ...
        form.value.userName =
          form.value.nickName + form.value.phonenumber.slice(-4)
